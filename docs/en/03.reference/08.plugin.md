...
> To use a custom criteria you must provide a **model** because the model returns it's criteria.{.notice}
...
> Cache automatically invalidates itself when any entry in the stream is modified.{.notice}
