...
The `AssetManager::` path hint represents your application's asset cache directory `public/app/{application}/`.
...
The `bower::` path hint represents the `bower_components/` directory where assets are downloaded by `bower`.
