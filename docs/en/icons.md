...
Icon definitions help abstract how your theme's icons are presented. By referring to an icon by a universal name and letting the registry provide the class you can easily swap out icon implementations.
