...
### [1.6.156] - 2019-06-19
#### Fixed
- Fixed issue in `\Anomaly\Streams\Platform\Ui\Table\Component\Filter\Guesser\PlaceholdersGuesser` where assignment field names were not taking proper precedence because it was assuming they would be translatable.  
