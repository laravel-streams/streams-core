...
class StreamsServiceProvider extends ServiceProvider
{
    ...
    protected function registerCore()
    {
        ...
        $this->app->register('Streams\Platform\Provider\ActiveDistributionServiceProvider');
        $this->app->register('Streams\Platform\Provider\ActiveModuleServiceProvider');
        $this->app->register('Streams\Platform\Provider\ActiveThemeServiceProvider');
    }
}
