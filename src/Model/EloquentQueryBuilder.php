...
class EloquentQueryBuilder extends Builder
{
    ...
    /**
     * Override joins to allow easier translation joins.
     *
     * @param string $table
     * @param null $first
     * @param null $operator
     ...
     * @param string $type
     * @param bool $where
     * @return $this|EloquentQueryBuilder
     */
    public function join($table, $first = null, $operator = null, $second = null, $type = 'inner', $where = false)
    {
        if ($table == 'translations') {
            return $this->joinTranslations();
        }

        return parent::join($table, $first, $operator, $second, $type, $where); // TODO: Change the autogenerated stub
    }
     ...
     * @param null $locale
     */
    public function joinTranslations($locale = null)
    {
